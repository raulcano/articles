...
El modelo original BTC S2F es una fórmula basada en el S2F mensual y precio del BTC. Ya que los datos de muestra estaban indexados cronologicamente, es un modelo con una serie temporal
